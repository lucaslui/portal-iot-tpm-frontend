...
import styles from './news-card-flexible.module.scss'
...
const NewsCardFlexible: React.FC<Props> = ({ article }: Props) => {
    return (
        <Link key={article.id} className={styles.news_card_full} href={`/${article.type}/${article.id}`}>
...
export default NewsCardFlexible