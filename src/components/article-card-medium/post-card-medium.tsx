...
import styles from './post-card-medium.module.scss'
...
const PostCardMedium: React.FC<Props> = async ({ article }: Props) => {
    return (
        <Link key={article.id} href={`/${article.type}/${article.id}`} className={styles.post_card_medium}>
            <div className={styles.image_container}>
                ...
                <Image src={article.imageUrl} loading={"lazy"} width={240} height={600} alt='Imagem de Capa do Artigo' />
            </div>
