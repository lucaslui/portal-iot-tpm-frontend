        ...
        <div className={styles.about_page}>
            ...
            <section className={`${poppins.className}`}>
                <p>
                    ...
                    O portal foi iniciado pelo desenvolvedor e entusiasta <a href="https://br.linkedin.com/in/lucas-lui-motta" target="_blank">Lucas Lui Motta</a>, que adora debater sobre o assunto e acredita no poder do ensino baseado em projetos.
